...
class NetworkTrainer:
    ...
    def train(self, args):
        ...
        collator = train_util.collator_class(current_epoch, current_step, ds_for_collator, args.train_batch_size)
        ...
        if args.deepspeed:
            ...
            if train_text_encoder:
                ...
                # Move text encoders to accelerator device even if not training them
                for t_enc in text_encoders:
                    t_enc.to(accelerator.device, dtype=weight_dtype)
